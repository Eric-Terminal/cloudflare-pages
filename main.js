...
const TURNSTILE_SCRIPT_SRC = "https://challenges.cloudflare.com/turnstile/v0/api.js?onload=onTurnstileScriptLoad&render=explicit";
...
class VerifyLandingPage {
    ...
    startTurnstileLoadAttempt(forceReload) {
    ...
    startTurnstileFallbackTimeout(attemptToken) {
        this.clearTurnstileFallbackTimeout();
    ...
    handleTurnstileUnavailable(message) {
        this.turnstileReady = false;
        this.resetTurnstileLoadingState();
        if (!this.isTurnstileStage()) {
            return;
    ...
    startRecaptchaLoadAttempt(forceReload) {
    ...
    startRecaptchaFallbackTimeout(attemptToken) {
        this.clearRecaptchaFallbackTimeout();
